...
{
	public sealed partial class ChoiceBeforeChangingMetadataSource : UserControl
	{
		...
		public static readonly DependencyProperty YesNoProperty =
			DependencyProperty.Register("YesNo", typeof(bool), typeof(ChoiceBeforeChangingMetadataSource), new PropertyMetadata(false));
		...
		public ChoiceBeforeChangingMetadataSource()
		{
			InitializeComponent();
		}
